    ...
    public function validateForm() {
        ...
        if($count>0) {
            ...
            if(preg_match("/$name/i", $this->name_book)) {
                header("Location:/admin/receive/create-book?msg_book_name_exist& name=$this->name_book&ref=$this->ref_book");
                exit();
            }

            if(preg_match("/$reference/i", $this->ref_book)) {
                header("Location:/admin/receive/create-book?msg_book_ref_exist& name=$this->name_book&ref=$this->ref_book");
                exit();
            }
